...
// Subscribes to FloorLoadedEvent in OnEnable ahead of GameplayHandler (default order), which raises it from Start
// when a floor is jumped to directly; no other script reads Instance today.
