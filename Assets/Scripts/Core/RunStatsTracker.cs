...
public class RunStatsTracker : MonoBehaviour
{
    ...
    public int XpPerLevelHudOverride { get; private set; }
    ...
    public void SetXpPerLevelHudOverride(int value)
    {
        XpPerLevelHudOverride = Mathf.Max(1, value);
    }

    public void ClearXpPerLevelHudOverride()
    {
        XpPerLevelHudOverride = 0;
    }
