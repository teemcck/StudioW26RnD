...
public sealed class AppliedUpgradesOverflowListPanel : MonoBehaviour
{
    ...
    public static AppliedUpgradesOverflowListPanel EnsureOnCanvas(Canvas canvas)
    {
        ...
        AppliedUpgradesOverflowListPanel existing = canvas.GetComponentInChildren<AppliedUpgradesOverflowListPanel>(true);
        if (existing != null)
            return existing;

        GameObject go = new GameObject("AppliedUpgradesOverflowList", typeof(RectTransform), typeof(CanvasGroup), typeof(AppliedUpgradesOverflowListPanel));
    ...
    public void Show(Transform hostStripRoot)
    {
        ...
        Canvas canvas = hostStripRoot.GetComponentInParent<Canvas>();
        if (canvas == null)
            return;
        ...
        RectTransform stripRt = hostStripRoot as RectTransform;
        if (stripRt != null)
        {
    ...
    private void BuildUi()
    {
        ...
        HorizontalLayoutGroup headerH = headerGo.GetComponent<HorizontalLayoutGroup>();
        ...
        GameObject closeGo = new GameObject("Close", typeof(RectTransform), typeof(Image), typeof(Button), typeof(LayoutElement));
        ...
        GameObject closeLabelGo = new GameObject("Label", typeof(RectTransform), typeof(TextMeshProUGUI));
        ...
        GameObject scrollGo = new GameObject("Scroll", typeof(RectTransform), typeof(ScrollRect), typeof(LayoutElement));
        ...
        GridLayoutGroup grid = _gridLayout;
        ...
        GameObject descGo = new GameObject("DescAnchor", typeof(RectTransform), typeof(LayoutElement));
    ...
    private void ConfigureGridForPanelWidth(float panelWidth, Transform hostStripRoot)
    {
        ...
        AppliedUpgradeStripUI stripUi = hostStripRoot != null ? hostStripRoot.GetComponentInParent<AppliedUpgradeStripUI>() : null;
    ...
    private void PopulateFromStrip(Transform hostStripRoot)
    {
        ...
        {
            UpgradeDisplaySO display = applied[i];
    ...
    {
        GameObject cell = new GameObject($"{display.upgradeID}_Cell", typeof(RectTransform), typeof(Image));
        ...
        CardHover hover = cell.AddComponent<CardHover>();
        hover.Configure(display, stacks);
        hover.ConfigureDetailPlacement(CardHover.DetailAnchor.BelowAnchor, compact: true);

        if (stacks >= 2)
        {
            GameObject badge = new GameObject("Badge", typeof(RectTransform), typeof(TextMeshProUGUI));
            ...
            TextMeshProUGUI badgeTmp = badge.GetComponent<TextMeshProUGUI>();
