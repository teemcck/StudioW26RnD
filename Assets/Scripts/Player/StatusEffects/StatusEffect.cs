...
public class StatusEffect
{
    ...
    public StatusEffect(StatusEffectId id, float duration, int maxStacks = 1, bool isPermanent = false)
    {
        this.id = id;
    ...
    {
        StatusEffect copy = new StatusEffect(id, duration, maxStacks, isPermanent)
        {
