// ShieldBreakShockwaveVfx drives _WaveProgress through a per-renderer property block.
// The transparent ring refracts URP's opaque scene texture and adds an energy-colored glow.
Shader "Boss/StunShockwaveDistort"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Keep material tuning together; each spawned wave overrides only its progress.
            ...
            // The shared quad provides local position and centered ring UV coordinates.
            struct Attributes
            {
            ...
            // Clip position draws the quad; screenPos locates the background for refraction.
            struct Varyings
            {
            ...
            // Preserve local UVs for the ring and project the vertex for screen-color sampling.
            ...
            // Form a smooth radial band, offset the background sample, and fade everything outside the band.
            half4 frag(Varyings i) : SV_Target
            {
                ...
                // A Gaussian band expands with progress; sharpness controls its visible thickness.
                ...
                // Blend the unshifted and refracted background before adding the ring's emissive tint.
